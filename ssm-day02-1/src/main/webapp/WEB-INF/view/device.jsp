...
<body class="gray-bg">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveDevice.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>设备名称：</td>
								<td><input type="text" id="username" name="deviceName"
							...
							<tr>
								<td>设备类型：</td>
								<td colspan="2">
									<select class="form-control" name="deviceTypeId" id = "roleid" aria-required="true" required>
										<option value="">---请选择---</option>
	...
	function initEditUser(getSelection){
		...
		$('#roleid').val(getSelection.deviceTypeId);
		$('#username').val(getSelection.deviceName);
